...
const DrawerPrimitive = DialogPrimitive
...
>(({ side = "right", className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 flex h-full w-full bg-background p-6 shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out",
        side === "top" &&
...
const DrawerFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse px-4 sm:flex-row sm:justify-end sm:space-x-2", 
      className
    )}
    {...props}
  />
